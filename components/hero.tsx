      ...
      <div className="relative container mx-auto px-4 h-screen flex items-center">
        <div className="max-w-2xl">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Discover the ultimate destination for professional esports. Follow
            your favorite teams, track player statistics, and get exclusive
            merchandise from the {"world's"} top gaming organizations.
          </p>
